...
/*
  Liveness for Readers: It is always true that eventually, the number of active readers will be greater than 0.
  This implies that if readers want to read, they eventually will.
  This property holds if there are always readers attempting to read.
*/
