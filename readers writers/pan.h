...
#define PanSource	"readers_writers.pml"
...
#define _nstates6	14	/* liveness_queue */
#define minseq6	91
#define maxseq6	103
#define _endstate6	13

#define _nstates5	14	/* liveness_writers */
#define minseq5	78
#define maxseq5	90
#define _endstate5	13

#define _nstates4	14	/* liveness_readers */
#define minseq4	65
#define maxseq4	77
#define _endstate4	13

#define _nstates3	11	/* mutual_exclusion */
#define minseq3	55
#define maxseq3	64
#define _endstate3	10

#define _nstates2	22	/* :init: */
#define minseq2	34
#define maxseq2	54
#define _endstate2	21

#define _nstates1	18	/* Writer */
#define minseq1	17
#define maxseq1	33
#define _endstate1	17

#define _nstates0	18	/* Reader */
#define minseq0	0
#define maxseq0	16
...
typedef struct P6 { /* liveness_queue */
...
typedef struct P5 { /* liveness_writers */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P4 { /* liveness_readers */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P3 { /* mutual_exclusion */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Air1	(sizeof(P1) - Offsetof(P1, mypos) - 1*sizeof(uchar))
...
#define Air0	(sizeof(P0) - Offsetof(P0, mypos) - 1*sizeof(uchar))
...
#define HAS_TRACK	0
/* hidden variable: */	uchar q_id[5];
/* hidden variable: */	uchar q_kind[5];
